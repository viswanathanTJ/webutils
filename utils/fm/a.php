...
<head>
    ...
    (function($) {
        ...
        $.fn.tablesortby = function(idx, direction) {
            ...
            $(this).find('thead th:nth-child(' + (idx + 1) + ')').addClass(direction ? 'sort_desc' :
                'sort_asc');
    ...
    $(function() {
        ...
        function renderFileSizeErrorRow(file, folder) {
            return $row = $('<div class="error" />')
                .append($('<span class="fileuploadname" />').text('Error: ' + (folder ? folder + '/' : '') +
                    file.name))
        ...
        function list() {
            ...
            $.get('?do=list&file=' + hashval, function(data) {
                ...
                if (data.success) {
                    ...
                    !data.results.length && $tbody.append(
                        '<tr><td class="empty" colspan=5>This folder is empty</td></tr>')
                    data.is_writable ? $('body').removeClass('no_write') : $('body').addClass(
                        'no_write');
                } else {
